...
class SoliTest {
    ...
    @Test
    void calculate_2018() {
        Double result = new Soli(new Income(50000d), new Configuration2018()).getSoliValue();
    ...
    void calculate_2018_small() {
        Double result = new Soli(new Income(3000d), new Configuration2018()).getSoliValue();
    ...
    void calculate_2018_large() {
        Double result = new Soli(new Income(250000d), new Configuration2018()).getSoliValue();
    ...
    void calculate_2018_underLimit() {
        Double result = new Soli(new Income(650d), new Configuration2018()).getSoliValue();
